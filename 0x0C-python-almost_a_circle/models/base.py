...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """ Writes the JSON string reppresentation of list_objs to a file.
        Args:
        - list_objs: list of instances who inherits Base
        """
        """
        if not isinstance(list_objs, list) and list_objs is nor None:
        raise TypeError("Objects must be a list of instances")
